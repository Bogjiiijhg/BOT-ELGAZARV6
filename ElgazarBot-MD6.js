...
ElgazarBot.sendMessage(m.chat, { caption: `حقوق: eslam hassanᴀʟᴡᴀᴢᴇʀ `, video: { url: data.watermark }, buttons: button, footer: botname, mentions: [sender] })
})
}
break
case 'tiktokaudio':{
...
⋆ يمكنك التواصل مع المبرمج عبر التيلجرام ⤌⤈
 t.me/eslamboho
تبعني عبر الجروب  ⤌⤈
https://chat.whatsapp.com/F7iVHfpZUrn34fOb2slGB7
